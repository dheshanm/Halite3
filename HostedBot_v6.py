...
while True:
    ...
    if EMERGENCY:
        ...
        if game.turn_number <= TURNCOUNT*.6 and me.halite_amount >= (constants.SHIP_COST) * 1 and not game_map[
            me.shipyard].is_occupied and me.shipyard.position not in queued_coords:
            command_queue.append(me.shipyard.spawn())
            logging.info("Deploying Ship")
        elif game.turn_number > TURNCOUNT*.6 and me.halite_amount >= constants.SHIP_COST * 1 and not game_map[
